...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "CyberGuard NG — AI Security for Nigerian SMEs" },
      { name: "twitter:description", content: "Enterprise-grade cybersecurity built for Nigerian SMEs, schools, churches, hospitals and startups." },
    ],
    links: [
      {
        rel: "stylesheet",
